...
COUNTERS = [
    ...
    # ---------------- News Outlets ----------------
    _static("wabc-ny", "news-outlets", 1, "WABC-TV (New York)", "", detail="New York local news channel covering the Tri-State area."),
    _static("ktla-ca", "news-outlets", 2, "KTLA (California)", "", detail="Los Angeles local news station covering Southern California."),
    _static("wfaa-tx", "news-outlets", 3, "WFAA (Texas)", "", detail="Dallas-Fort Worth local news station covering North Texas."),
    _static("wsb-ga", "news-outlets", 4, "WSB-TV (Georgia)", "", detail="Atlanta local news channel covering North Georgia."),
    _static("wgn-il", "news-outlets", 5, "WGN-TV (Illinois)", "", detail="Chicago local news station covering Illinois and Chicagoland."),
    _static("wpvi-pa", "news-outlets", 6, "WPVI (Pennsylvania)", "", detail="Philadelphia local news station covering the Delaware Valley."),
    _static("wxyz-mi", "news-outlets", 7, "WXYZ (Michigan)", "", detail="Detroit local news channel covering Southeast Michigan."),
    _static("wral-nc", "news-outlets", 8, "WRAL (North Carolina)", "", detail="Raleigh local news station covering Eastern North Carolina."),
    _static("wplg-fl", "news-outlets", 9, "WPLG (Florida)", "", detail="Miami local news channel covering South Florida."),
    _static("wews-oh", "news-outlets", 10, "WEWS (Ohio)", "", detail="Cleveland local news channel covering Northeast Ohio."),
    _static("king-wa", "news-outlets", 11, "KING 5 (Washington)", "", detail="Seattle local news station covering Western Washington."),
    _static("wcvb-ma", "news-outlets", 12, "WCVB (Massachusetts)", "", detail="Boston local news channel covering Eastern Massachusetts."),
    _static("kpnx-az", "news-outlets", 13, "KPNX (Arizona)", "", detail="Phoenix local news channel covering Arizona."),
    _static("wthr-in", "news-outlets", 14, "WTHR (Indiana)", "", detail="Indianapolis local news channel covering Central Indiana."),
    _static("wmc-tn", "news-outlets", 15, "WMC-TV (Tennessee)", "", detail="Memphis local news channel covering West Tennessee and Mid-South."),
    _static("ksdk-mo", "news-outlets", 16, "KSDK (Missouri)", "", detail="St. Louis local news station covering Eastern Missouri and Illinois."),
    _static("wbal-md", "news-outlets", 17, "WBAL-TV (Maryland)", "", detail="Baltimore local news channel covering Maryland."),
    _static("kusa-co", "news-outlets", 18, "KUSA (Colorado)", "", detail="Denver local news channel covering Colorado."),
    _static("wcco-mn", "news-outlets", 19, "WCCO (Minnesota)", "", detail="Minneapolis local news channel covering Minnesota."),
    _static("wtmj-wi", "news-outlets", 20, "WTMJ-TV (Wisconsin)", "", detail="Milwaukee local news channel covering Southeast Wisconsin."),
    _static("wwl-la", "news-outlets", 21, "WWL-TV (Louisiana)", "", detail="New Orleans local news channel covering Southeast Louisiana."),
    _static("wbrc-al", "news-outlets", 22, "WBRC (Alabama)", "", detail="Birmingham local news channel covering Alabama."),
    _static("wavy-va", "news-outlets", 23, "WAVY-TV (Virginia)", "", detail="Portsmouth-Norfolk local news channel covering Hampton Roads."),
    _static("wis-sc", "news-outlets", 24, "WIS-TV (South Carolina)", "", detail="Columbia local news channel covering South Carolina."),
    _static("wlbt-ms", "news-outlets", 25, "WLBT (Mississippi)", "", detail="Jackson local news channel covering Central Mississippi."),
]
